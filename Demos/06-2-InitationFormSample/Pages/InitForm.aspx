...
--%>
    <table>
      <tr><td>String:<br /><input type="text" id="strInput" /><br /><br /></td></tr>
        <tr><td>User Picker:<br/><SharePoint:PeopleEditor runat="server" AllowEmpty="False" ValidatorEnabled="True" MultiSelect="False" ID="peoplePicker"/></td></tr>
        <tr><td>
